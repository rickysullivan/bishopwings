...
mit.main = function() {
  ...
  */
  mit.gameOver = function() {
    ...
    // Share
    var tweet = document.getElementById("tweet");
    tweet.href='http://twitter.com/share?url=http://bronnycopter.com/&text=I just spent ' +Math.floor(mit.score)+ ' taxpayers\' dollars in Bronny Copter!&counturl=http://bronnycopter.com&count=horiztonal&via=rickysullivan&hastags=choppergate,meme,auspol,BronwynBishop,bronnycopter';
